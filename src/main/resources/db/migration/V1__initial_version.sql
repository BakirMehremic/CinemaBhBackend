...
ALTER TABLE "users"
    ADD FOREIGN KEY ("city_id") REFERENCES "cities" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "movies_personnel"
    ADD FOREIGN KEY ("personnel_id") REFERENCES "personnel" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "movies_personnel"
    ADD FOREIGN KEY ("movie_id") REFERENCES "movies" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "seats"
    ADD FOREIGN KEY ("hall_id") REFERENCES "halls" ("id") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "users_projections_seats"
    ADD FOREIGN KEY ("projection_id") REFERENCES "projections" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "users_projections_seats"
    ADD FOREIGN KEY ("seat_id") REFERENCES "seats" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "users_projections_seats"
    ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id") DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE "halls"
    ADD FOREIGN KEY ("venue_id") REFERENCES "venues" ("id") DEFERRABLE INITIALLY IMMEDIATE;
